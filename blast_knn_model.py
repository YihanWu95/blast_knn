...
class BlastKnnModel:
    ...
    def __init__(self,idxMF, idxBP, idxCC,x_test,unique_go_values,y_test,verbose):
        '''
    ...
    def blast(self):
        '''
        loaded Blast_knn_result_parents.npy and generate predict probabilities of selected proteins based on it and
        calculate corresponding f scores
        :return: predict probabilities and ground truth after embedding into ground truth spaces
        '''
        #initial predict matrix
        y_test_blast = []
    ...
    def prepare_blast_result(self,path):
        #path: path to blast-knn result e.g. "blast_knn_result_parent.npy"
        #Load and change blast result into suitable format
        ...
        for key in blast_knn_result:
            ...
            for go_name in blast_knn_result[key]['score']:
                ...
                result[key][new_go_name]  = mid[go_name]
